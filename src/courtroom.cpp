...
{
  QString p_identifier = "courtroom";

  if (!ao_app->parsed_theme_data.contains(p_identifier) || 
     ao_app->parsed_theme_data[p_identifier]["width"] < 0 ||
     ao_app->parsed_theme_data[p_identifier]["height"] < 0) {
...
void Courtroom::set_size_and_pos(QWidget *p_widget, QString p_identifier, QString p_misc)
{
  ...
  if (!ao_app->parsed_theme_data.contains(p_identifier)) {
      ...
      int y_position = ao_app->parsed_theme_data[p_identifier]["y"];
      ...
      if (Options::getInstance().menuBarLocked()) {
          ...
          QSet<QString> unaffected = {"message", "showname", "back_to_lobby", "char_buttons",
                                      "char_select_left", "char_select_right", "spectator", "char_password",
                                      "char_list", "char_taken", "char_passworded", "char_search",
                                      "left_evidence_icon", "right_evidence_icon", "music_name"};
          QSet<QString> affect = {"evidence_background", "evidence_button"};
      ...
      p_widget->move(ao_app->parsed_theme_data[p_identifier]["x"], y_position);
      p_widget->resize(ao_app->parsed_theme_data[p_identifier]["w"], ao_app->parsed_theme_data[p_identifier]["h"]);
  }
}
